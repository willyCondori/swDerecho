# modulo_auditoria/models/auditoria.py
...
class Auditoria(models.Model):
    ...
    accion: CREATE | READ | UPDATE | DELETE | LOGIN | LOGOUT | EXPORT | ANALYZE
    ...
    ip          = models.GenericIPAddressField(
                      null=True,
                      blank=True,
                      help_text="Dirección IP (IPv4 o IPv6) desde donde se originó la acción.",
                  )
